...
<html lang = "en-us">
    ...
    <body id = "body" >
        ...
        <span class = "<?php if (isset(!$errors ['natl_id'])): ?>result <?php else: ?> err <?php endif;?>"  id = "id"> <?php if(isset($errors['nat_id'])): echo $errors['natl_id']; endif?>; </span>
              <br><br>
              ...
              <input id = "Address" class = "add" type = "text" name = "address[]">&nbsp;
              <span class = "result" id = "address"></span> 
              <br><br>
              <label>Address 2:</label>
              <input id = "Address2" class = "add" type = "text" name = "address[]">&nbsp;
              <span class = "result" id = "address"></span> 
              <br><br>
